...
![registrate](https://github.com/NIKIplays2016/Telegram-server/blob/main/images/bot_using_3_menu.png?raw=true)
    ...
    1. Запуск файла - команда запускает файл с расширением .py .
         Пример: для файла main.py, после ввода команды нужно написать main.py

    2. Создание папки/директории - Команда создает папку в директории, с названием указаным после ввода команты 
         примечания: пробелы заменяются на _.

    3. Удаление папки - Удаляет папку/файл в директории в которой вы находитесь.

    4. Загрузка файлов - загружает файлы в текущую директорию. 
         Нет ограничений на количество файлов отправленных за раз. 
         Для остановки режима загрузки файлов надо ввести комманду /stop или в командном меню внажать на команду Stop.
